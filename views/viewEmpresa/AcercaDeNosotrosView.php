  ...
  <main class="main-content"><!-- Stats Banner -->
   ...
   <div class="info-grid">
    <div class="info-card">
     ...
     <p class="info-card-text">Libramiento Tecnológico S/N-A.P. 247, Santa María Coapan, Sta María Coapan, 75770 Tehuacán, Pue.</p><a href="https://www.google.com/maps?gs_lcrp=EgZjaHJvbWUqCAgBEAAYFhgeMgYIABBFGDkyCAgBEAAYFhgeMggIAhAAGBYYHjIICAMQABgWGB4yBwgEEAAY7wUyCggFEAAYgAQYogQyCggGEAAYogQYiQUyBwgHEAAY7wUyCggIEAAYgAQYogTSAQoxNjAwMWowajE1qAIMsAIB8QUkn3qL_ADdQA&um=1&ie=UTF-8&fb=1&gl=mx&sa=X&geocode=KTGjeNoCvcWFMS5BbV-OpZpp&daddr=Libramiento+Tecnol%C3%B3gico+S/N-A.P.+247,+Santa+Mar%C3%ADa+Coapan,+Sta+Mar%C3%ADa+Coapan,+75770+Tehuac%C3%A1n,+Pue." target="_blank" rel="noopener noreferrer" class="info-card-link">Ver en mapa →</a>
    </div>
    <div class="info-card">
     <div class="info-card-icon">
      📅
