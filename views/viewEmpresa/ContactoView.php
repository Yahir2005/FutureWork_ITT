 ...
 <body><!-- Header -->
  ...
  <main class="container"><!-- Mensajes de alerta --> <!-- 
   ...
   <div class="map-section">
    ...
    <p class="section-subtitle">Visítanos en nuestras instalaciones del Instituto Tecnológico de Tehuacán.</p><!-- Placeholder para mapa (aquí se integraría Google Maps o similar) -->
