...
<head>
  ...
  <title>FutureWork ITT - Inicio Postulante</title>
  ...
  <nav class="navbar">
    <div class="navbar-container">
      <a href="?cargar=Home" class="navbar-logo">
        <div class="logo-circle">FW</div>
        <span class="logo-text">FutureWork ITT</span> 
      </a> 
      ...
      <div class="navbar-actions">
        <div class="user-badge">
          ...
          <a class="nav-link" href="?cargar=PerfilPostulanteView"><span>Postulante</span></a>
        </div>
        <a href="?cargar=closeSession" class="flex items-center gap-1 bg-red-600 hover:bg-red-700 text-white text-sm font-bold py-2 px-4 rounded transition duration-300 ease-in-out shadow-md">
          <span>🚪</span> 
          <span>Salir</span>
        </a>
      </div>
      ...
      <?php
          ...
          if(isset($_GET['cargar'])){
              if($enrutador->validarGET($_GET['cargar'])){
                  ...
                  // Opcional: Cargar una vista de error 404
                  echo "<p class='text-center mt-5'>Página no encontrada.</p>";
              }
          } else {
              // Vista por defecto si no hay variable GET
